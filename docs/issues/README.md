...
| [009](009-far-village-tactical-window-and-network-ceiling.md) | Residuals: far-village tactical-window arrival, netVil 72% ceiling, trough cost | Low | ✅ **CONFIRMED characterized remainder 2026-06-10** (re-measured 180/300 = 60% arrival; genuine terrain distance, not a defect) — honest remainder of 006/008 |
...
| [011](011-deploy-relief-bake-cost.md) | Deploy-time relief bake (4096² sheet) is the dominant load cost (~seconds) | Low–Medium | 🟢 **CHARACTERIZED 2026-06-10** — resolution-lowering DEGRADES the relief (do-not on a fidelity-first project); cost covered by the loading screen; right fix = fidelity-preserving seed-keyed cache / worker, GPU-measured. |
