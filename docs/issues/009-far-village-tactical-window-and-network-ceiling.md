...
> **Ledger status (verified 2026-07-16 @ da10926):** RESOLVED (honest residual, re-confirmed 2026-06-10) — the shipped connectivity guard + movement economy are current; the "residual" is realistic terrain distance across a tunable tactical window (`ITM_REACH_MAXS`), not an unfixed defect.
